        ...
        <div className="create-listing-content create-wizard-content">
          <div className="create-listing-text">
            ...
            <h1 className="create-listing-title">
              {isService ? "Make your service stand out" : "Make your place stand out"}
            </h1>
            <p className="create-listing-description">
              {isService
                ? `In this step, you’ll add some of the amenities your ${selectedOption || "service"} offers, plus 5 or more photos. Then, you’ll create a title and description.`
...
export default MakePlaceStandOut;
